package com.jbm.springboot.controller;
...
import com.jbm.springboot.controller.ProjectManagerController;
import com.jbm.springboot.service.ProjectManagerService;
...
public class ProjectManagerControllerTest {
	...
	public void setUp() throws Exception {
		projectManagerService = Mockito.mock(ProjectManagerService.class);
		projectManagerController = new ProjectManagerController(projectManagerService);
	}
	...
	public void testTest() {
		...
		Assert.assertEquals(testhome, "Project Manager App - Creator: Jyotibikash Mahakuda");
	}
